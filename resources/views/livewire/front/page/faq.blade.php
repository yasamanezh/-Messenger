                ...
                <div class="col-lg-4 col-md-12">
                    <div class="faq-sidebar">
                        <ul>
                            ...
                            <div id="collapse-{{$parent->id}}" class="accordion-collapse {{$loop->first ? '' : 'collapsed'}}" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <ul class="pt-0 nav nav-tabs">

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link  {{$loop->first ? 'active' : ''}}" id="home{{$child->id}}-tab" data-bs-toggle="tab" data-bs-target="#tab-{{$child->id}}" type="button" role="tab" aria-controls="home{{$child->id}}" aria-selected="true">{{$this->getTranslate('title',$child)}}</button>
                                    </li>
                                </ul>
                            </div>
                            @endforeach
