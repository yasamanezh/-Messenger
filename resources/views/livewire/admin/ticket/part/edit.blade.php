<div>
@section('title',__('Edit Part'))
<div class="container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Edit Part</h2><br>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{route('admin.tickets.part')}}">Part</a></li>
                    <li class="breadcrumb-item active" aria-current="page"> Edit Part</li>
                </ol>
            </div>
            <div>
                <a data-toggle="tooltip" href="{{route('admin.tickets.part')}}" class="btn btn-warning text-white"  data-original-title="back">
        ...
        <div class="row row-sm">
            <div class="col-lg-12 col-md-12">
                <div class="card custom-card">
                    <div class="card-body">
                        <div>
                            <h6 class="main-content-label mb-1">Add Part category</h6>
                            <p class="text-muted card-sub-title">Add Part general information and translate</p>
                        </div>
