<div>
@section('title',__('Pack options'))
<div class="container-fluid">
    <div class="inner-body" wire:init="loadPage"  >
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Pack options</h2><br>
                <ol class="breadcrumb">
            ...
            <div class="d-flex">
                <div class="justify-content-center">
                    <a href="{{route('admin.pack.option.add')}}" class="btn ripple btn-primary">Add <i class="fa fa-plus-circle ml-0"></i> </a>
                </div>
            </div>
        </div>
                                ...
                                <table class="table dataTable no-footer dtr-inline ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                <a href="{{route('admin.pack.option.edit',$item->translateable->id)}}" class="btn btn-sm btn-info">
