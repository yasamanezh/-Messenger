<div>
    @section('title',__('Add faq category'))
    <div class="container-fluid">
        <div class="inner-body">
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Add faq category</h2><br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('admin.faqs')}}">faq category</a></li>
            ...
            <div class="row row-sm">
                <div class="col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                <h6 class="main-content-label mb-1">Add faq category</h6>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" wire:model.defer="parent" >
                                                        ...
                                                        <option value="{{$value->id}}">{{$value->currentTranslate()->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
