    ...
    <div class="container-fluid">
        <div class="inner-body">
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit faq category</h2><br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('admin.helps')}}">faqs category</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Edit faq category</li>
                    </ol>
                </div>
                <div>
                    <a data-toggle="tooltip" href="{{route('admin.helps')}}" class="btn btn-warning text-white"  data-original-title="back">
            ...
            <div class="row row-sm">
                <div class="col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                <h6 class="main-content-label mb-1">edit faq category</h6>
                                    ...
                                    <div class="content clearfix tab-content mh-260" id="myTabContent"> 
                                        <div  wire:ignore.self class="tab-pane fade show active" id="general" role="tabpanel">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 form-label">parent:</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control" wire:model.defer="parent" >
                                                        <option value="">select</option>
                                                        <option value="0">No parent</option>
                                                        @foreach($parents as $value)
                                                        <option {{$value->translateable_id == $parent ? 'selected' : ''}} value="{{$value->id}}">{{$value->currentTranslate()->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @error('parent') <div class="invalid-feedback display-block" style="display: block">  {{ $message }} </div> @enderror
                                            </div>
