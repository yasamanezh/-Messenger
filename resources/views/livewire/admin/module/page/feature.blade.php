<div>
    @section('title',__('Edit feature page'))
    <div class="container-fluid">
        <div class="inner-body">
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit feature page</h2><br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('admin.pages')}}" >pages</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Edit feature page</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="row row-sm">
                <div class="col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                <h6 class="main-content-label mb-1">Edit feature page</h6>
