<div>
    @section('title',__('Edit Video Module'))
    <div class="container-fluid">
        <div class="inner-body">
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit Video Module</h2><br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('admin.modules')}}">Modules</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Edit Video Module</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="row row-sm">
                <div class="col-lg-12 col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            <div>
                                <h6 class="main-content-label mb-1">Edit Video Module</h6>
                                ...
                                <div id="wizard3" class="wizard clearfix vertical">
                                    ...
                                    <div class="content clearfix tab-content mh-260" id="myTabContent"> 
                                        <div  wire:ignore.self class="tab-pane fade show active" id="general" role="tabpanel">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 form-label"> video(youtube link):</label>
                                                <div class="col-md-9">
                                                    <input placeholder="video"  class="form-control @error('video') is-invalid @enderror"  wire:model.defer="video">
