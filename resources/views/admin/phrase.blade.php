...
<div class="container-fluid">
    <div class="inner-body">
         <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit phrase</h2><br>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('translations_ui.index')}}">languages</a></li>
                        <li class="breadcrumb-item"><a href="{{route('translations_ui.phrases.index',$translation)}}">phrases</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> Edit phrase</li>
                    </ol>
                </div>
